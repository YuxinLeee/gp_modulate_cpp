...
public:             
        ...
        lpvDS(const int K, const int M, const MatrixXd Priors_fMatrix, const MatrixXd Mu_fMatrix, const MatrixXd Sigma_fMatrix, const MatrixXd A_fMatrix, const VectorXd att_fVector);
        ...
        VectorXd  operator()(VectorXd xi){
                return this->compute_f(xi);
        }
...
private:
        void        setup_params();
        void        initialize_att(const VectorXd fMatrix);
